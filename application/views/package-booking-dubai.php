                                ...
                                <div class="person-information">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 col-md-5">
                                            ...
                                            <input type="hidden" name="amount" class="input-text full-width" value="48030.00" placeholder="" />
                                            <input type="hidden" name="productinfo" class="input-text full-width" value="Dubai Packages" placeholder="" />
                                        </div>
                                        <div class="col-sm-6 col-md-5">
                    ...
                    <div class="sidebar col-sms-6 col-sm-4 col-md-3">
                        <div class="booking-details travelo-box">
                            ...
                            <article class="image-box hotel listing-style1">
                                <figure class="clearfix">
                                    ...
                                    <div class="travel-title">
                                        <h5 class="box-title">Dubai <small>Packages</small></h5>
                                ...
                                <div class="details">
                                    ...
                                    <div class="guest">
                                        <small class="uppercase">4 Nights / 5 Days in Dubai</small>
                                    </div>
                                </div>
                            </article>
                            ...
                            <dl class="other-details">
                               <dl class="other-details">
                                <dt class="feature">Package:</dt><dd class="value">Dubai</dd>
                                <dt class="feature">Package Cost:</dt><dd class="value">RS. 45,000</dd>
                                
                                <dt class="feature">GST @ 3.625%:</dt><dd class="value">RS. 1,631</dd>
								<dt class="feature">Online Charge:</dt><dd class="value">Rs. 1,399</dd>
                                <dt class="total-price">Total Price</dt><dd class="total-price-value">RS. 48,030</dd>
                               </dl>
                            </dl>
                        </div>
