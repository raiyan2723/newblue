                                ...
                                <div class="person-information">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 col-md-5">
                                            ...
                                            <input type="hidden" name="amount" class="input-text full-width" value="32020.00" placeholder="" />
                                            <input type="hidden" name="productinfo" class="input-text full-width" value="Singaporer Packages" placeholder="" />
                                        </div>
                                        <div class="col-sm-6 col-md-5">
                    ...
                    <div class="sidebar col-sms-6 col-sm-4 col-md-3">
                        <div class="booking-details travelo-box">
                            ...
                            <article class="image-box hotel listing-style1">
                                <figure class="clearfix">
                                    ...
                                    <div class="travel-title">
                                        <h5 class="box-title">Singapore <small>Packages</small></h5>
                                ...
                                <div class="details">
                                    ...
                                    <div class="guest">
                                        <small class="uppercase">3 Nights / 4 Days in Singapore</small>
                                    </div>
                                </div>
                            </article>
                            ...
                            <dl class="other-details">
                               <dl class="other-details">
                                <dt class="feature">Package:</dt><dd class="value">Singapore</dd>
                                <dt class="feature">Package Cost:</dt><dd class="value">RS. 30,000</dd>
                                
                                <dt class="feature">GST @ 3.625%:</dt><dd class="value">RS. 1,087</dd>
								<dt class="feature">Online Charge:</dt><dd class="value">Rs. 933</dd>
                                <dt class="total-price">Total Price</dt><dd class="total-price-value">RS. 32,020</dd>
                               </dl>
                            </dl>
                        </div>
