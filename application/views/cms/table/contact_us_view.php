               ...
               <div class="tile-body color transparent-black rounded-corners">
                  <div class="table-responsive">
                     <table  class="table table-datatable table-custom" id="basicDataTable">
						...
						<td>
							<a href="<?php echo base_url()?>index.php/User/Contact_Details/<?= $data["c_id"]; ?>"><b>View</b></a>
							&nbsp; <a href="<?php echo base_url()?>index.php/User/Delete_Contact/<?= $data["c_id"]; ?>"><b>Delete</b></a>
						</td>
						</tr>
							<?php }?>
                            </tbody>
