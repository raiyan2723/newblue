      ...
      <div class="row">
         ...
         <div class="col-md-10">
            ...
            <section class="tile transparent">
               <!-- tile header -->
                <div> <a href="index.php/Cms/Add_Contact"><button type="button" class="btn btn-primary margin-bottom-20">Add Record</button></a></div>
                     ...
                     <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
                           <tr>
								...
								<th class="sort-numeric">Address</th>
							<th>Options</th>
                           </tr>
                        </thead>
                        <tbody>
						...
						<tr>
						<td><?php echo $menu["a_id"];?></td>
						<td><?=$menu["phone"];?></td>
						<td><?=$menu["email"];?></td>
						<td><?=$menu["address"];?></td>
						
						<td>
						 &nbsp; <a href="<?php echo base_url()?>index.php/Action/Update_Contact/<?= $menu["a_id"]; ?>"><b>Update</b></a>
						 &nbsp; <a href="<?php echo base_url()?>index.php/Action/Delete_Contact/<?= $menu["a_id"]; ?>"><b>Delete</b></a>
						</td>
						</tr>
