      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <section class="tile transparent">
               <!-- tile header -->
                <div> <a href="index.php/Cms/Footer_About"><button type="button" class="btn btn-primary margin-bottom-20">Add Record</button></a></div>
               ...
               <div class="tile-body color transparent-black rounded-corners">
                  <div class="table-responsive">
                     <table  class="table table-datatable table-custom" id="basicDataTable">
						...
						<tr>
						<td><?php echo $menu["abt_id"];?></td>
						<td><?=substr($menu["content"],0,20);?></td>
						<td><?=$menu["phone"];?></td>
						<td><?=$menu["email"];?></td>
						
						<td>
						 &nbsp; <a href="<?php echo base_url()?>index.php/Action/Update_Footer_About/<?= $menu["abt_id"]; ?>"><b>Update</b></a>
						 &nbsp; <a href="<?php echo base_url()?>index.php/Action/Delete_Footer_About/<?= $menu["abt_id"]; ?>"><b>Delete</b></a>
						</td>
						</tr>
