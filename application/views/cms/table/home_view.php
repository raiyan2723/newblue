               ...
               <div class="tile-body color transparent-black rounded-corners">
                  <div class="table-responsive">
                     <table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
                           <tr>
                             ...
                             <th class="sort-alpha">Packages Name</th> 
                              ...
                              <th class="sort-amount">Country Name </th>
                             <th class="sort-numeric">Package Cast</th>
							<th class="sort-numeric">City Name</th>
							<th>Options</th>
                           </tr>
                        </thead>
                        <tbody>
						...
						<td><img src="<?=$data["image"]; ?>" class="img-thumbnail" alt="Cinque Terre" width="150" height="236" alt="" /></td>
							<td><?=substr($data["Country_name"],0,20);?></td>
						<td><?=substr($data["Packages_Cost"],0,20);?></td>
						<td><?=substr($data["City_name"],0,20);?></td>
						<td>
						 <a href="<?php echo base_url()?>index.php/Cms/Home_data/<?= $data["id"]; ?>"><b>View</b></a>
						 &nbsp; <a href="<?php echo base_url()?>index.php/Action/Update_Home/<?= $data["id"]; ?>"><b>Update</b></a>
						 &nbsp; <a href="<?php echo base_url()?>index.php/Action/Delete_Home/<?= $data["id"]; ?>"><b>Delete</b></a>
						</td>
						</tr>
							<?php }?>
                            </tbody>
