      ...
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <section class="tile color transparent-black">
               ...
               <!-- tile body -->
               <div class="tile-body">
                  <form class="form-horizontal" role="form" parsley-validate=""  action ="<?php echo base_url();?>index.php/Cms/insert_slider_image" ns" method="POST" enctype="multipart/form-data">
