      ...
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <section class="tile color transparent-black">
               ...
               <!-- tile body -->
               <div class="tile-body">
                  <form class="form-horizontal" role="form" parsley-validate=""  action ="<?php echo base_url();?>index.php/Cms/insert_about" id="basicvalidations" method="POST" enctype="multipart/form-data">
                    
					    <div class="form-group transparent-editor">
                        <label class="col-sm-4 control-label">Blue Sky Excursions</label>
                        <div class="col-sm-8">
                          <textarea class="form-control" id="input06" name="Blue_Sky"></textarea>
                        </div>
                      </div>
					 ...
					 <div class="form-group transparent-editor">
                        ...
                        <div class="col-sm-8">
                          <textarea class="form-control" id="input07" name="Mission"></textarea>
                        </div>
                      </div>
