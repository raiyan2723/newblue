<div id="content" class="col-md-12" tabindex="5001" style="overflow: hidden; outline: none; padding-left: 265px;">
   ...
   <div class="pageheader">
      <h2><i class="fa fa-check-square" style="line-height: 48px;padding-left: 1px;"></i>Add Footer About<span>.</span></h2>
      ...
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <section class="tile color transparent-black">
               ...
               <!-- tile body -->
               <div class="tile-body">
                  <form class="form-horizontal" role="form" parsley-validate=""  action ="<?php echo base_url();?>index.php/Cms/Insert_Footer_About" id="basicvalidations" method="POST" enctype="multipart/form-data">
