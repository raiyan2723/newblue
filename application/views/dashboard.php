            ...
            <div class="container">
                <h1 class="logo navbar-brand">
                    <a href="index.html" title="Travelo - home">
                        <img src="assest/images/logo2.png" alt="Travelo HTML5 Template" />
                    </a>
                </h1>
                <ul class="quick-menu pull-right hidden-mobile">
                    <li class="ribbon menu-color-blue">
                        ...
                        <ul class="menu mini uppercase">
                            ...
                            <li><a href="#wishlist" class="location-reload">wishlist</a></li>
                            <li><a href="#travel-stories" class="location-reload">travel stories</a></li>
