        ...
        <div class="page-title-container">
            <div class="container">
                ...
                <ul class="breadcrumbs pull-right">
					...
					<li><a href="index.php/Index_controller/leisures">LEISURES</a></li>
                    <li class="active">Malaysia</li>
                </ul>
            </div>
        </div>
                               ...
                               <div class="post-meta">
                                    <div class="post-content-wrapper">
                                        <figure class="image-container">
                                            <a href="#" ><img src="assest/images/leisure/malaysia.jpg" alt="" /></a>
                                        </figure>
                                        <div class="details">  
                    ...
                    <div class="tab-container full-width-style white-bg">
                        ...
                        <div class="tab-content">
                           <div class="tab-pane fade active in" id="first-tab">
								...
								<p><span class="price"><small>PACKAGE COST</small>र 25,000</span> 
								</p>
																<p>&nbsp;</p>
