      ...
      <div class="row">
         <div id="main" class="col-sms-6 col-sm-8 col-md-9">
            <div class="booking-section travelo-box">
               ...
               <br/>
               <?php } ?>
               <div class="col-sm-6 col-md-5"><button type="submit" class="full-width btn-large " ><a href="#travelo-login" class="soap-popupbox">Login &amp; Continue</a></button></div>
               ...
               <form action="index.php/Index_controller/save_gestuser" method="post" name="gest_user">
         ...
         <div class="sidebar col-sms-6 col-sm-4 col-md-3">
            <div class="booking-details travelo-box">
               ...
               <dl class="other-details">
                  <dt class="feature">Package:</dt>
                  <dd class="value"><?php echo $booking['Packages_Name']; ?></dd>
                  <dt class="feature">Package Cost:</dt>
                  <dd class="value">RS. <?php echo $booking['Package_Cast']; ?></dd>
                  <dt class="feature">GST @ 3.625%:</dt>
                  <dd class="value">RS. <?php echo $booking['Other_Charge']; ?></dd>
                  <dt class="feature">Online Charge:</dt>
                  <dd class="value">Rs. <?php echo $booking['Online_Charge']; ?></dd>
                  <dt class="total-price">Total Price</dt>
                  <dd class="total-price-value">RS. <?php echo $Total_cost; ?></dd>
               </dl>
            </div>
