                                ...
                                <div class="person-information">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 col-md-5">
                                            ...
                                            <input type="text" name="firstname" class="input-text full-width"  value="<?php echo (empty($user['first_name'])) ? '' : $user['first_name']; ?>">
                                        ...
                                        <div class="col-sm-6 col-md-5">
                                            <label>last name</label>
												<input type="text" name="lastname" class="input-text full-width" value="<?php echo (empty($user['last_name'])) ? '' : $user['last_name']; ?>" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 col-md-5">
                                            <label>email address</label>
                                            <input type="text" name="email" class="input-text full-width"  value="<?php echo (empty($user['email'])) ? '' : $user['email']; ?>" placeholder="" />
                                        </div>
                                        <div class="col-sm-6 col-md-5">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 col-md-5">
                                            ...
                                            <input type="text" name="phone" class="input-text full-width" value="<?php echo (empty($user['phone'])) ? '' : $user['phone']; ?>" placeholder="" />
                                        </div>
                                    </div>
