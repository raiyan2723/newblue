    <!-- Flex Slider -->
    <script type="text/javascript" src="booking/components/flexslider/jquery.flexslider-min.js"></script>
    ...
    <!-- waypoint -->
    <script type="text/javascript" src="booking/js/waypoints.min.js"></script>

    <!-- load page Javascript -->
    <script type="text/javascript" src="booking/js/theme-scripts.js"></script>
