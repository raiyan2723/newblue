...
<div id="slideshow">
    <div class="fullwidthbanner-container">
        <div class="revolution-slider" style="height: 0; overflow: hidden;">
            ...
            <ul>    <!-- SLIDE  -->
                ...
                <!-- Slide1 -->
                <?php foreach ($slider_data as $employee) { ?>
 ...
 <?php //if($this->session->flashdata('msg')):echo $this->session->flashdata('insert');endif; ?><br/>
<section id="content">
    <div class="search-box-wrapper">
        <div class="search-box container">
            <ul class="search-tabs clearfix">
                <li class="active"><a href="#hotels-tab" data-toggle="tab">LEISURES</a></li>
            ...
            <div class="visible-mobile">
                <ul id="mobile-search-tabs" class="search-tabs clearfix">
                    <li class="active"><a href="#hotels-tab">LEISURES</a></li>
    ...
    <!-- Popuplar Destinations add to controlle -->



    <!-- Honeymoon add to controller -->
