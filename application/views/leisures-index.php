                  ...
                  <div class="post-meta">
                     <div class="post-content-wrapper">
                        <figure class="image-container">
                           <a href="index.php/Index_controller/i_package/<?php echo $data["Location_name"];?>" ><img src="<?=$data["Packages_image"]; ?>" alt="" /></a>
                        </figure>
                        <?php  $i=0;  foreach ($menu as $employee) 
											{ 
												   if($data["Location_name"] == $employee["Location_name"])   
												   {								
												   ?>
												<div class="details">
												   <h2 class="text-uppercase"><?=$employee["Packages_Name"]; ?></h2>
