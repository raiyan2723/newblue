   ...
   app.controller('operator_Ctrl', function($scope, $http, $log) {
       ...
       $http.post("index.php/Service/count_table_row/category_time")
       ...
       $scope.show               = function() {
          ...
          $http.post("index.php/Service/table_whr_data/category_time/id", {
       ...
       $scope.center_edit              = function(index) {
           ...
           $http.post('index.php/Service/edit_data/category_time/id', {
               'id': index
       ...
       $scope.save = function() {
           ...
           for (i = 0; i < $scope.inputs.length; i++) {
               $scope.data.push({
                   'center_id'  : $scope.input_center_id,
                   'center_name': $scope.input_center_name,
                   'category'   : $scope.inputs[i].category,
                   'time'       : $scope.inputs[i].time
               });
           }

           $http.post("index.php/Service/insert_all/category_time", {
               'data': $scope.data
           }).success(function(response) {
               console.log("response", response);
               //location.reload();
